...
// RealOrchestrator coordonne le crawling et l'analyse SEO réelle
...
// RealOrchestratorConfig configuration pour le RealOrchestrator
type RealOrchestratorConfig struct {
	MaxPages        int
	MaxWorkers      int
	InitialWorkers  int
...
// NewRealOrchestrator crée un nouveau orchestrateur réel
func NewRealOrchestrator() *RealOrchestrator {
	realConfig := &RealOrchestratorConfig{
		MaxPages:       constants.RealOrchestratorMaxPages,
		MaxWorkers:     constants.RealOrchestratorMaxWorkers,
		InitialWorkers: constants.RealOrchestratorInitialWorkers,
		Timeout:        time.Duration(constants.RealOrchestratorAnalysisTimeout),
...
func (ro *RealOrchestrator) GetConfig() *RealOrchestratorConfig {
	return ro.config
}

// StartAnalysis démarre une nouvelle analyse complète
func (ro *RealOrchestrator) StartAnalysis(targetURL string) (string, error) {
	// Validation de l'URL
...
func (ro *RealOrchestrator) GetStatus(analysisID string) (*AnalysisState, error) {
	ro.mu.RLock()
	defer ro.mu.RUnlock()
...
func (ro *RealOrchestrator) runCompleteAnalysis(analysisID string) {
...
func (ro *RealOrchestrator) performCrawling(analysisID, targetURL string) ([]*crawler.PageResult, error) {
...
func (ro *RealOrchestrator) performSEOAnalysis(analysisID string, crawlResults []*crawler.PageResult) ([]*seo.RealPageAnalysis, error) {
...
func (ro *RealOrchestrator) aggregateResults(analysisID string, pageAnalyses []*seo.RealPageAnalysis) {
	state := ro.getState(analysisID)
	if state == nil {
		return
	}
...
func (ro *RealOrchestrator) completeAnalysis(analysisID string) {
	state := ro.getState(analysisID)
	if state == nil {
		return
	}
...
func (ro *RealOrchestrator) generateAnalysisID() string {
...
func (ro *RealOrchestrator) getState(analysisID string) *AnalysisState {
	ro.mu.RLock()
	defer ro.mu.RUnlock()
	return ro.analyses[analysisID]
}

func (ro *RealOrchestrator) updateState(analysisID, status, message string) {
	ro.mu.Lock()
	state, exists := ro.analyses[analysisID]
	if exists {
		state.Status = status
...
func (ro *RealOrchestrator) updateStateError(analysisID, errorMessage string) {
	ro.mu.Lock()
	state, exists := ro.analyses[analysisID]
	if exists {
...
func (ro *RealOrchestrator) sendUpdate(analysisID, message, status string) {
...
func (ro *RealOrchestrator) prioritizeRecommendations(allRecs []seo.RealRecommendation) []seo.RealRecommendation {
...
func (ro *RealOrchestrator) extractTopIssues(recommendations []seo.RealRecommendation) []seo.RealRecommendation {
...
func (ro *RealOrchestrator) GetUpdatesChannel() <-chan AnalysisUpdate {
	return ro.updates
}

// Shutdown arrête proprement l'orchestrateur
func (ro *RealOrchestrator) Shutdown() error {
	ro.mu.Lock()
	defer ro.mu.Unlock()
...
func (ro *RealOrchestrator) loadExistingAnalyses() {
...
func (ro *RealOrchestrator) saveAnalysisToStorage(analysis *AnalysisState) {
...
func (ro *RealOrchestrator) convertToStorage(integrationAnalysis *AnalysisState) *storage.AnalysisState {
...
func (ro *RealOrchestrator) convertFromStorage(storageAnalysis *storage.AnalysisState) *AnalysisState {
...
func (ro *RealOrchestrator) TestCrawl(ctx context.Context, url string) (*crawler.ParallelCrawlResult, error) {
